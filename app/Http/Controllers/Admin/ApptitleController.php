...
class ApptitleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($files = $request->file('image'))
        {
            ...
            $imagepath = upload_path('uploads/logo/logo/'. $testiimage->image, true);
            if(File::exists($imagepath)){
                File::delete($imagepath);
            }
            
            //insert new file
            $destinationPath = upload_path('uploads/logo/logo/'); // upload path
        ...
        if ($files = $request->file('image1'))
        {
            ...
            $imagepath1 =   upload_path('uploads/logo/darklogo/'. $testiimage1->image1, true);
            if(File::exists($imagepath1)){
                File::delete($imagepath1);
            }
            
            //insert new file
            $destinationPath = upload_path('uploads/logo/darklogo/'); // upload path
            $profileImage = date('YmdHis') . "." . $files->getClientOriginalExtension();
            $files->move($destinationPath, $profileImage);
        ...
        if ($files = $request->file('image2'))
        {
            ...
            $imagepath2 =   upload_path('uploads/logo/icon/'. $testiimage2->image2, true);
            if(File::exists($imagepath2)){
                File::delete($imagepath2);
            }
            
            //insert new file
            $destinationPath = upload_path('uploads/logo/icon/'); // upload path
            $profileImage = date('YmdHis') . "." . $files->getClientOriginalExtension();
            $files->move($destinationPath, $profileImage);
        ...
        if ($files = $request->file('image3'))
        {
            ...
            $imagepath3 =   upload_path('uploads/logo/darkicon/'. $testiimage3->image3, true);
            if(File::exists($imagepath3)){
                File::delete($imagepath3);
            }
            
            //insert new file
            $destinationPath = upload_path('uploads/logo/darkicon/'); // upload path
            $profileImage = date('YmdHis') . "." . $files->getClientOriginalExtension();
            $files->move($destinationPath, $profileImage);
        ...
        if ($files = $request->file('image4'))
        {
            ...
            $imagepath4 =   upload_path('uploads/logo/favicons/'. $testiimage4->image4, true);
            ...
            //insert new file
            $destinationPath = upload_path('uploads/logo/favicons/'); // upload path
            $profileImage = date('YmdHis') . "." . $files->getClientOriginalExtension();
            $files->move($destinationPath, $profileImage);
    ...
    public function logodelete(Request $request)
    {
        ...
        if($request->logo == 'logo1'){
            if($logo->image != null){
                $imagepath =   upload_path('uploads/logo/logo/'. $logo->image, true);
                if(File::exists($imagepath)){
                    File::delete($imagepath);
                }
            }
        ...
        if($request->logo == 'logo2'){
            if($logo->image1 != null){
                $imagepath =   upload_path('uploads/logo/darklogo/'. $logo->image1, true);
                if(File::exists($imagepath)){
                    File::delete($imagepath);
                }
            }
        ...
        if($request->logo == 'logo3'){
            if($logo->image2 != null){
                $imagepath =   upload_path('uploads/logo/icon/'. $logo->image2, true);
                if(File::exists($imagepath)){
                    File::delete($imagepath);
                }
            }
        ...
        if($request->logo == 'logo4'){
            if($logo->image3 != null){
                $imagepath =   upload_path('uploads/logo/darkicon/'. $logo->image3, true);
                if(File::exists($imagepath)){
                    File::delete($imagepath);
                }
            }
        ...
        if($request->logo == 'logo5'){
            if($logo->image4 != null){
                $imagepath =   upload_path('uploads/logo/favicons/'. $logo->image4, true);
                if(File::exists($imagepath)){
                    File::delete($imagepath);
                }
            }
